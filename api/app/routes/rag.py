...
DOCUMENTS = [
    {
        "id": "UK-SPEC-ISPRL-CAPACITY",
        "title": "Reference Specification: Strategic Petroleum Reserves & Caverns",
        "source": "Urja Kavach Intelligence Specifications Library",
        "date": "March 12, 2026",
        "summary": "Calibration parameters for ISPRL cavern fill levels, storage capacities, and OMC commercial reserve baselines.",
        "content": "The Indian Strategic Petroleum Reserves Limited (ISPRL) capacity is 5.33 Million Metric Tonnes (MMT) across three underground rock cavern facilities: Visakhapatnam (1.33 MMT), Mangaluru (1.50 MMT), and Padur (2.50 MMT). The active fill level is 63.26% of capacity (~3.372 MMT, or 23,357,267.4 barrels using the cavern-specific conversion rate of 6.926829 bbl/MMT). These caverns correspond to 9.5 days of national consumption cover, and Oil Marketing Companies (OMCs) commercial reserves are set to 64.5 days of storage, yielding a total of 74 days of national cover based on the 5.0M bpd national consumption base."
    },
    {
        "id": "UK-SPEC-REFINERY-DATA",
        ...
        "content": "India's total refining sector nameplate capacity is 251.2 MMTPA. Public sector refiners account for approximately 65% of processed crude. The Reliance Industries Jamnagar complex has a capacity of 1.24 million bpd (approx 62 MMTPA). Sourcing metrics are calibrated with a 15-percentage-point composition shift, representing non-Hormuz sourcing share rising from 55% to 70% to evaluate maritime supply disruption contingencies."
    },
    {
        "id": "UK-SPEC-CONTINGENCY-ROUTING",
        ...
        "content": "Alternative routing contingencies redirect imports through West Africa, the US Gulf Coast, and Guyanese supply corridors. The 15% non-Hormuz sourcing shift is a fixed absolute volume offset of 660,000 bpd (calculated against the 4.4M bpd import capacity) to evaluate transit shortfalls regardless of the shortfall percentage. Supply lanes are mapped via coordinates from the Information Fusion Centre (IFC-IOR)."
    },
    {
        "id": "UK-SPEC-PHASE2-PLAN",
        ...
        "content": "Phase II SPR expansion covers the establishment of additional Strategic Petroleum Reserves (SPR) caverns. The expansion includes two planned caverns: a 4.0 MMT facility at Chandikhole in Odisha, and a 2.5 MMT facility at Padur in Karnataka. This adds 6.5 MMT of storage capacity, bringing total strategic reserve capacity to 11.83 MMT aligned with the IEA's 90-day recommended cover target."
    },
    {
        "id": "UK-SPEC-HORMUZ-RISK",
        ...
        "content": "The Strait of Hormuz is the world's most critical oil chokepoint. Approximately 60% of India's crude imports transit this corridor, representing ~2.64 million bpd of the 4.4 million bpd total import base. The navigable channel is 2-3 miles wide in each direction, with an average daily transit of 17-20 Very Large Crude Carriers (VLCCs). A sustained 50% capacity disruption reduces India's crude availability by ~1.32 million bpd, triggering emergency SPR drawdown at approximately 139,000 metric tonnes per day. The IRGC seizure risk is correlated with GDELT news volume z-scores above 2.0. Primary naval chokepoint coordinates: 26.57N, 56.45E. The corridor risk weight in Urja Kavach is 0.35 for GDELT news volume, 0.30 for AIS vessel deviation, 0.25 for Brent price volatility, and 0.10 for OFAC sanctions flag."
    },
    {
        "id": "UK-SPEC-IMPORT-MATRIX",
    ...
    },
    {
        ...
        "content": "If the Strait of Hormuz is blocked, tankers from Middle Eastern terminals (Ras Tanura, Fujairah) must reroute via the Cape of Good Hope, adding approximately 6,000-6,500 nautical miles and 10-14 transit days per voyage. This rerouting reduces delivered volume capacity by 20-25% due to extended vessel turnaround time. The Cape route is available at 100% capacity with no chokepoint restriction. The additional transit cost is USD 1.2-1.8 million per voyage (bunker and hire combined). Bab el-Mandeb closure forces combined Cape plus West Africa rerouting, compounding transit costs to USD 2.1-2.7 million per voyage. The IFC-IOR (Information Fusion Centre Indian Ocean Region) coordinates vessel tracking for the Cape corridor."
    },
    {
        "id": "UK-SPEC-RUSSIA-OFAC",
    ...
    },
    {
        ...
        "content": "The ISPRL emergency drawdown protocol operates in three trigger tiers: Tier 1 (risk score 60-79) triggers advisory alert and pre-positions procurement alternatives; Tier 2 (score 80-89) activates OMC commercial reserve drawdown with 64.5 days available; Tier 3 (score 90-100) authorizes ISPRL strategic cavern release. Maximum strategic cavern release rate is 200,000 bpd across all three ISPRL facilities combined. At a national consumption of 5.0 million bpd and current ISPRL fill level of 63.26% equaling 3.372 MMT or approximately 23.36 million barrels, the strategic reserve provides approximately 4.67 days of cover at maximum drawdown rate. Combined with OMC commercial reserves providing 64.5 days, total national autonomy is 69.17 days under a zero-import scenario. Replenishment lead time after drawdown is 21-30 days for the West Africa corridor and 14-21 days for the Americas corridor."
    }
]
